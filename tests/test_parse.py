...
@pytest.mark.parametrize("acl, grantee, grantor, privs, privswgo", parse_table_data)
...
@pytest.mark.parametrize("acl, grantee, grantor, privs, privswgo", parse_type_data)
def test_parse_type(acl, grantee, grantor, privs, privswgo):
    parsed = parse_acl_item(acl, PgObjectType.TYPE)
    assert parsed == Privileges(grantee, grantor, privs, privswgo)


@pytest.mark.parametrize("acl, grantee, grantor, privs, privswgo", parse_fdw_data)
...
@pytest.mark.parametrize("acl, grantee, grantor, privs, privswgo", parse_lob_data)
